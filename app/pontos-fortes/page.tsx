        ...
        <div className="grid gap-4">
          {[pair.a, pair.b].map((item) => (
            <button
              ...
              className="group bg-white rounded-2xl border-2 border-gray-200 hover:border-blue-500 hover:bg-blue-50 shadow-sm px-6 py-6 text-left transition-all"
            >
              <span className="text-lg text-gray-800 group-hover:text-blue-900 leading-relaxed">
                {item.text}
              </span>
            </button>
          ))}
